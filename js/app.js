...
function calcular(){
    ...
    const div1Monto = divisaElem1.value;
    const div2Monto = divisaElem2.value;

    //TODAVIA NO PUEDO TERMINARLO POR FALTA DE CONOCIMIENTO ACERCA DE FETCH
    // //Fetch de la divisa elegida (FALTA APRENDER MAS PARA TERMINARLO)
    // fetch(`https://v6.exchangerate-api.com/v6/d3430ab49a6224316cd79eb7/latest/${div1Monto}`){}
}
